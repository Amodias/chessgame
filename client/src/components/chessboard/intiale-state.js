...
export const initilaeState = () => {
  return {
    ...
    b1: { component: Knight, type: "n", color: "white" },
    ...
    g1: { component: Knight, type: "n", color: "white" },
    ...
    b8: { component: Knight, type: "n", color: "black" },
    ...
    g8: { component: Knight, type: "n", color: "black" },
